...
<head>
    ...
    <link rel="stylesheet" href="../assets/template/font-awesome/css/font-awesome.css">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="metode.php" data-target="#collapseUtilities" aria-expanded="true"
                    aria-controls="collapseUtilities">
                    <i class="fa-solid fa-bacteria"></i>
                    <span>Perhitungan KNN</span>
                </a>
            </li>

            <!-- Nav Item - Perhitungan Menu -->
            <li class="nav-item">
                <a class="nav-link" href="hasil.php" data-target="#collapseUtilities" aria-expanded="true"
                    aria-controls="collapseUtilities">
                    <i class="fa-solid fa-bacteria"></i>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="logout.php" data-toggle="modal" data-target="logout.php">
